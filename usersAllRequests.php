...
<html lang = "hr">
    <head>
        <title>Korisnikovi zahtjevi</title>
        <meta charset="UTF-8">
    ...
    <body>
        <header>
            <nav>
                <ul>
                    ...
                    <li><a class="currentPageHighlight" href="usersAllRequests.php">>POPIS ZAHTJEVA KORISNIKA</a></li>
        ...
        <?php
        //TABLICA DNEVNIK
        require './php/populateTableUsersAllRequests.php';
        ?>
        <footer>
