...
<html lang = "hr">
    ...
    <body>
        <header>
            <nav>
                <ul>
                    ...
                    <li><a class="currentPageHighlight" href="bills.php">RAČUNI</a></li>
        ...
        <form class="registration_form" method="get" name="login_form" action="./bills.php">
            <?php
//TABLICA DNEVNIK
            require './php/populateTableBills.php';
            ?>
