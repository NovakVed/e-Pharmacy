...
<html lang = "hr">
    <head>
        ...
        <script type="text/javascript" src="./javascript/ajaxUserControlAdministrator.js"></script>
    ...
    <body>
        <header>
            <nav>
                <ul>
                    ...
                    <li><a class="currentPageHighlight" href="userControlAdministrator.php">>UPRAVLJANJE KORISNICIMA</a></li>
        ...
        <p>Pronađi korisnika:
            ...
            <a href="./forms/registerNewModerator.php">Napravite novog korisnika</a>
            <button style="float: right" onclick="printPage()">Print</button>
        </p>
        <form class="registration_form" method="post" name="login_form" action="./creatingMedicationType.php">
            <table id = "table">
                <?php
                require './php/populateTableUserAdministrator.php';
                ?>
            </table>
        </form>
        <footer>
