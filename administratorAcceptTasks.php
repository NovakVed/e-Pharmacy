...
//include_once './templates/baza.class.php.php';
...
<html lang = "hr">
    <head>
        ...
        <script type="text/javascript" src="javascript//ajaxAdministratorAcceptTasks.js"></script>
    ...
    <body>
        <header>
            <nav>
                <ul>
                    ...
                    <li><a class="currentPageHighlight" href="administratorAcceptTasks.php">>ADMINISTRATOR ODOBRAVA ZAHTJEVE</a></li>
        ...
        <table id = 'load'></table>
            <?php
//TABLICA
//            require './php/populateTableAdministratorAcceptTasks.php';
            ?>
