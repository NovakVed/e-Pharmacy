...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "<table class = 'tableScrollUser'>
            ...
            <tr>
                <th><a href='acceptingRequests.php?order=idzahtjev&&sort=$sort'>IDzahtjeva</a></th>
                <th><a href='acceptingRequests.php?order=naziv_zahtjeva&&sort=$sort'>Naziv zahtjeva</a></th>
                <th><a href='acceptingRequests.php?order=opis_zahtjeva&&sort=$sort'>Opis zahtjeva</a></th>
                <th><a href='acceptingRequests.php?order=datum&&sort=$sort'>Datum</a></th>
                <th><a href='acceptingRequests.php?order=kolicina&&sort=$sort'>Količina</a></th>
                <th><a href='acceptingRequests.php?order=status_zahtjeva&&sort=$sort'>Status zahtjeva</a></th>
                <th>Uplati</th>
                <th></th>
            </tr>"
    . "<tbody id='myTable'>";
...
//        . "<td><input type='checkbox' name='idZahtjev[]' id='idZahtjev' value='" . $db_idZahtjev . " $disabled'></td>"
        . "<td><select $disabled name='selectArgument[]' onchange='changeDatabase(this.value)'>"
